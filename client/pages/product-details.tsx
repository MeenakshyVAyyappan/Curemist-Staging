...
export default function ProductDetailsPage() {
  ...
  /* Embla carousel setup for mechanism section */
      ...
      <div className="pd-page">
        ...
        <div className="pd-hero">
              ...
              {productImages.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-2 rounded-full shadow-md z-10 opacity-70 hover:opacity-100 transition-opacity focus:outline-none"
                  ...
                  <button
                    ...
                    className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-2 rounded-full shadow-md z-10 opacity-70 hover:opacity-100 transition-opacity focus:outline-none"
          ...
          <div className="pd-info">
            ...
            <p className="pd-subtext">
              World's First Ayurvedic Wound Spray — forms a waterproof,
              dust-proof bio-film instantly. Trusted by thousands of Indian
              families for everyday first-aid.
            </p>
            ...
            {saving > 0 && <p className="pd-saving">You save ₹{saving}! 🎉</p>}
            ...
            <div className="pd-highlights">
              {[
                ...
                { num: "Zero", label: "Parabens / Sulfates" },
              ].map((h) => (
          ...
          <div className="pd-container">
            ...
            <div className="pd-desc-grid">
              <div className="pd-desc-text">
                ...
                <p>
                  CureMist represents a breakthrough in first-aid care — the
                  world's first Ayurvedic wound spray that combines the ancient
                  wisdom of Indian botanicals with cutting-edge German polymer
                  technology.
                </p>
                <p>
                  Unlike traditional antiseptics that sting and dry out the
                  skin, CureMist creates a breathable, waterproof bio-film that
                  protects the wound while actively promoting healing through
                  its powerful Ayurvedic ingredients.
                </p>
                <p>
                  Registered under AYUSH License No: L-AUS-676. Manufactured in
                  a GMP-certified, ISO-certified facility. Clinically tested on
                  human subjects with zero adverse effects.
                </p>
              </div>
              <div>
                <div className="pd-spec-table">
                  {[
                    ...
                    [
                      "Primary Benefit",
                      product.benefit ?? "Anti Fungal, Wound Healing",
                    ],
                    ["Shelf Life", "3 Years"],
                    [
                      "Suitable For",
                      "All ages — Men, Women, Children, Elderly",
                    ],
                  ].map(([key, val]) => (
          ...
          <div className="pd-container">
            ...
            <div className="pd-mechanism-header">
              ...
              <p className="pd-mechanism-subtitle">
                Understanding how CureMist works at a cellular level to
                ...
                <div className="pd-mechanism-grid">
                  {[
                    ...
                    <div key={item.title} className="embla-slide-container">
                      <div className="pd-mechanism-card">
                        <div
                        ...
                        <h3 className="pd-mechanism-card-title">
                          {item.title}
                        </h3>
                        <p className="pd-mechanism-card-detail">
                          {item.detail}:
                        </p>
            ...
            <div className="pd-phyto-header pd-phyto-header--inner">
              ...
              <p className="pd-section-sub">
                Clinically proven phytochemicals that drive the healing power of
                CureMist.
              </p>
            </div>
        ...
        <section className="pd-nwc-section">
          <div className="pd-container">
            <div className="pd-nwc-header">
              ...
              <h2 className="pd-nwc-title">
                A Natural Wound Care
                <br />
                Liquid Bandage
              </h2>
        ...
        <section className="pd-how-section">
          <div className="pd-container">
            ...
            <p className="pd-section-sub">
              Three simple steps — and your wound is protected in under a
              minute.
            </p>
        ...
        <section className="pd-ingredients-section">
          <div className="pd-container">
            ...
            <p className="pd-section-sub">
              A powerful blend of time-tested Ayurvedic botanicals with modern
              science.
            </p>
        ...
        <section className="pd-related-section">
          <div className="pd-container">
            ...
            <p className="pd-section-sub" style={{ marginBottom: 36 }}>
              Explore other CureMist sizes and combos — get the right one for
              your needs.
            </p>
