...
export default function ResetPassword() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 pt-[110px] pb-10 px-4">
                <Card className="w-full max-w-md text-center py-10 px-6">
                    <CardTitle className="text-2xl font-bold mb-4">Validating reset link...</CardTitle>
                    <CardDescription className="text-gray-700 text-base">Please wait while we prepare your password reset page.</CardDescription>
                </Card>
            </div>
        );
    }
    ...
    if (!user) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 pt-[110px] pb-10 px-4">
                <Card className="w-full max-w-md text-center py-10 px-6">
                    <CardTitle className="text-2xl font-bold mb-4">Password Reset Link</CardTitle>
                    <CardDescription className="text-gray-700 text-base mb-6">
                        Please open the password reset link from your email again. You should be redirected automatically with the correct authorization token.
                    </CardDescription>
