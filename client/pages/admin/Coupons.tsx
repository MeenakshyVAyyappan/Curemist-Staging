...
export default function AdminCoupons() {
  ...
  const handleCreateCoupon = async () => {
    ...
    const newCoupon = {
      ...
      discount_percentage:
        discountType === "percentage" ? parseFloat(value) / 100 : null,
  ...
  const handleUpdateCoupon = async () => {
    ...
    const updates = {
      discount_percentage:
        editDiscountType === "percentage" ? parseFloat(editValue) / 100 : null,
      discount_amount:
        editDiscountType === "fixed" ? parseFloat(editValue) : null,
    };
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <Switch
                            ...
                            onCheckedChange={() =>
                              toggleStatus(coupon.code, coupon.is_active)
                            }
                          />
                          <Badge
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Button
                    variant={
                      editDiscountType === "percentage" ? "default" : "outline"
                    }
                  ...
                  <Button
                    variant={
                      editDiscountType === "fixed" ? "default" : "outline"
                    }
              ...
              <div className="flex justify-end gap-3 mt-4">
                ...
                <Button onClick={handleUpdateCoupon} className="bg-brand-blue">
                  Save Changes
                </Button>
              </div>
            </CardContent>
