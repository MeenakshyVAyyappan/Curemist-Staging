        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-24 max-w-4xl">
          ...
          <div className="bg-gradient-to-r from-brand-blue to-[#1a2a6c] rounded-2xl p-6 md:p-8 mb-10 text-white">
            ...
            <p className="text-white/80 text-sm md:text-base leading-relaxed">
              At CureMist (Altus Pharma), we handle your personal data with the
              highest level of care and transparency. Please read this policy
          ...
          <p className="text-xs text-gray-400 text-center mt-10">
            ...
            updates via email or a notice on our website.
          </p>
        </div>
      </section>
