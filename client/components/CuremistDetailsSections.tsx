                                ...
                                {[
                                    ...
                                    <div key={item.title} className="embla-slide-container">
                                        <div className="pd-mechanism-card h-full">
                                            <div className="pd-mechanism-card-icon" style={{ display: "flex", justifyContent: "center", alignItems: "center", margin: "0 auto" }}>
                                                {item.icon}
                                            </div>
                                            <h3 className="pd-mechanism-card-title text-center">{item.title}</h3>
                                            <p className="pd-mechanism-card-detail text-center">{item.detail}:</p>
                                            <p className="pd-mechanism-card-text text-center">{item.text}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
