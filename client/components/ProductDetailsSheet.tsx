    ...
    <SheetContent side="right">
      <div className="max-w-[520px] w-full h-full flex flex-col">
        ...
        <div className="overflow-y-auto pr-2 pb-6">
          ...
          <SheetHeader>
            <SheetTitle className="text-2xl font-bold text-black mb-2">
              {title}
            </SheetTitle>
        ...
        <SheetFooter className="mt-auto">
          <button
            ...
            className="w-full bg-brand-yellow hover:bg-brand-yellow/90 text-brand-blue px-6 py-4 rounded-md text-sm font-bold mt-2"
          >
            ADD TO CART
          </button>
        </SheetFooter>
