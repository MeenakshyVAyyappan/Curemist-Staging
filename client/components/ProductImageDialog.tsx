...
export default function ProductImageDialog({
  ...
  const discountAmount =
    numericOriginal > numericPrice ? numericOriginal - numericPrice : 0;
            ...
            <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6 lg:p-8">
              <div className="space-y-3 sm:space-y-4 md:space-y-6">
                ...
                <div className="space-y-2 sm:space-y-3 bg-gray-50 rounded-lg sm:rounded-xl p-3 sm:p-4">
                  <h3 className="font-semibold text-gray-900 text-xs sm:text-sm uppercase tracking-wide">
                    Product Details
                  </h3>
                  <div className="space-y-1.5 sm:space-y-2">
                    <div className="flex justify-between items-center py-1.5 sm:py-2 border-b border-gray-200">
                      ...
                      <span className="text-xs sm:text-sm font-bold text-brand-blue">
                        {size.toUpperCase()}
                      </span>
                    </div>
                    <div className="flex justify-between items-center py-1.5 sm:py-2 border-b border-gray-200">
                ...
                {/* Description */}
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1.5 sm:mb-2 text-xs sm:text-sm uppercase tracking-wide">
                    Description
                  </h3>
                  <div className="mb-1 text-[13px] sm:text-sm font-semibold text-brand-blue">
                    Description Header
                  </div>
                ...
                <div>
                  ...
                  <div className="inline-flex items-center rounded-lg sm:rounded-xl bg-gradient-to-r from-[#FFF8EC] to-[#FFFBF0] p-1.5 sm:p-2 shadow-md border border-yellow-200">
                    ...
                    <div className="mx-2 sm:mx-3 md:mx-4 bg-white px-4 sm:px-6 md:px-8 py-1.5 sm:py-2 md:py-3 rounded-lg border-2 border-brand-yellow shadow-sm">
                      <span className="text-base sm:text-lg md:text-xl font-bold text-brand-blue">
                        {formattedQty(qty)}
                      </span>
                    </div>
                    <button
