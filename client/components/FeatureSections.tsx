const TurmericIcon = () => (
  ...
  >
    <path
      d="M0 22.9706C0.160555 23.0528 1.01816 23.9178 1.17871 24C0.787113 20.4775 2.28302 19.4168 3.85333 19.4521C15.754 19.726 21.2364 9.98043 22 0C18.8515 2.54403 -3.80242 0.571428 0.787113 15.7808C3.5283 9.90998 8.3058 8.37182 14.0271 7.86693C5.94446 9.82779 1.47241 15.0372 0 22.9706Z"
      fill="#D5A000"
    />
  </svg>
);
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
          ...
          <div className="bg-white rounded-lg p-6 md:p-8 lg:p-12 shadow-lg relative">
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              <p className="text-base md:text-lg font-medium text-black leading-relaxed">
                Traditional healing meets advanced technology to give Indian
                families a safer, faster, and more reliable first-aid solution.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 md:p-8 lg:p-12 shadow-lg relative">
            ...
            <h3 className="text-2xl md:text-3xl lg:text-[33px] font-extrabold text-black mb-4 md:mb-6 leading-tight tracking-tight">
              ...
              Faster Healing. Zero Hassle.
            </h3>
            <p className="text-base md:text-xl lg:text-[21px] font-medium text-black mb-4 md:mb-6 leading-relaxed">
              Smart Healing Technology Inside.
              <br />
              Designed for modern lifestyles, Cure Mist works instantly—without
              touch.
            </p>
            ...
            <div className="space-y-2 md:space-y-3">
              {[
                {
                  text: "Quick-Drying Technology",
                  sub: "(Dries in under 1 minute)",
                },
                {
                  text: "Forms a Waterproof & Dustproof",
                  sub: "Protective Film",
                },
                {
                  text: "Bio-Safe Protective Layer using German",
                  sub: "Technology",
                },
                {
                  text: "Reduced Scarring Technology, especially",
                  sub: "for burn wounds",
                },
                {
                  text: "Long shelf life – remains effective for up to 3 years from the date of manufacture.",
                  sub: "",
                },
              ].map((feature, index) => (
                <div key={index} className="flex items-start gap-2 md:gap-3">
                  ...
                  <p className="text-base md:text-lg font-semibold text-black leading-tight">
                    ...
                    {feature.sub && (
                      <>
                        <br />
                        <span className="font-semibold">{feature.sub}</span>
                      </>
                    )}
                  </p>
                </div>
