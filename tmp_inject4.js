...
content = addErrorTextByValue(content, 'billingAddress', 'street', 'Street Address is required');
content = addErrorTextByValue(content, 'billingAddress', 'city', 'City/Town is required');
content = addErrorTextByValue(content, 'billingAddress', 'state', 'State/Province is required');
content = addErrorTextByValue(content, 'billingAddress', 'zip', 'ZIP/Postal Code is required');
content = addErrorTextByValue(content, 'billingAddress', 'country', 'Country is required');
